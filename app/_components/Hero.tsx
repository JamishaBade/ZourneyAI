...
// function Hero() {
//   const { user } = useUser();       // ✅ top-level hook
...
//             <Button size="icon" className="bg-[var(--primary)] text-white" onclick={()=>onSend()}>
//               <Send />
//             </Button>
//           </div>
//         </div>
...
function Hero() {
  ...
  return (
    <div className="mt-24 flex-col items-center flex space-y-8">
      ...
      <h2 className="my-7 mt-14 flex gap-2 text-center">
        Not sure where to begin? <strong>See how it works</strong>{" "}
        <ArrowDown />
      </h2>
